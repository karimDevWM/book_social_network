...
import { findAllRetunededBooks } from '../fn/book/find-all-retuneded-books';
import { FindAllRetunededBooks$Params } from '../fn/book/find-all-retuneded-books';
import { findBookById } from '../fn/book/find-book-by-id';
import { FindBookById$Params } from '../fn/book/find-book-by-id';
import { findBooks } from '../fn/book/find-books';
import { FindBooks$Params } from '../fn/book/find-books';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findAllRetunededBooks()` */
  static readonly FindAllRetunededBooksPath = '/books/returned';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllRetunededBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllRetunededBooks$Response(params?: FindAllRetunededBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllRetunededBooks(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllRetunededBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllRetunededBooks(params?: FindAllRetunededBooks$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllRetunededBooks$Response(params, context).pipe(
  ...
  static readonly FindBooksPath = '/books/all';
   ...
   * This method doesn't expect any request body.
   */
  findBooks$Response(params?: FindBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBookResponse>> {
    return findBooks(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  findBooks(params?: FindBooks$Params, context?: HttpContext): Observable<PageResponseBookResponse> {
    return this.findBooks$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseBookResponse>): PageResponseBookResponse => r.body)
    );
  }
